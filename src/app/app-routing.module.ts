...
const routes: Routes = [
  ...
  { path: "houses", component: HousesComponent, canActivate: [AuthGuard, ModuleGuard], data: { module: 'houses' } },
  {
    ...
    data: { module: 'vehicles', moduleAny: ['vehicles', 'external_visits'], defaultTab: 'residents' },
  },
  {
    path: "external-visits",
    component: VehiclesComponent,
    canActivate: [AuthGuard, ModuleGuard],
    data: { module: 'external_visits', moduleAny: ['vehicles', 'external_visits'], defaultTab: 'external' },
  },
  ...
  { path: "cameras", component: CamerasComponent, canActivate: [AuthGuard, ModuleGuard], data: { module: 'cameras' } },
